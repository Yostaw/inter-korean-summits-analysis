# `inter_korean_summits` Data Dictionary

This data dictionary is adapted from the course repository dataset documentation for the inter-Korean summit corpus used in this study.
